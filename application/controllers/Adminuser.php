...
class Adminuser extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'CUELSA : Dashboard';
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'CUELSA : User Listing';
    ...
    function addNewUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>$roleId,'batchNo'=>$batchNo, 'name'=> $name,
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CUELSA : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'CUELSA : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CUELSA : User Login History';
