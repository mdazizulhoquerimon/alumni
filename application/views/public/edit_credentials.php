                    ...
                    <div class="profile-block">
                        <div class="panel text-center">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="editcredentials"><i class="fa fa-lock"></i>Edit Login
                                        Credentials</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="col-xs-12">
                                        ...
                                        <form class="form-horizontal" name="editcredentials" action="editcredentials"
                                              method="POST">
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Email:</label>
                                                <div class="col-lg-8">
                                                    <input name="email" id="email" class="form-control" type="text"
                                                           value="<?php echo $fetched_user_data['email']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input name="username" id="username" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['username']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input name="password2" id="password2" class="form-control"
                                                           type="password" value="" placeholder="********">
                                                </div>
                                            </div>
                                            <div class="form-group">
