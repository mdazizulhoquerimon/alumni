          ...
          <div class="col-sm-9">              
              ...
              <div class="panel panel-default">
                 <div class="panel-heading resume-heading">
                          ...
                          <div class="col-xs-12">
                             ...
                             <table class="table table-user-information">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Email</td>
                                    <td><a href="mailto:<?php echo $fetched_user_data['email']; ?>"><?php echo $fetched_user_data['email']; ?></a></td>
                                  </tr>
                                    <td>Phone Number</td>
                    ...
                    <h4 class="text-center" style="margin-bottom: 10px;">Something about <?php echo $fetched_user_data['fullname']; ?></h4>
                    <p>
