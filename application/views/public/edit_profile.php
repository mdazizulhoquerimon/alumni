                    ...
                    <div class="profile-block">
                        <div class="panel text-center">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="editprofile"><i class="fa fa-pencil-square-o"></i>Edit
                                        profile</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="col-xs-12">
                                        ...
                                        <form class="form-horizontal" name="edituserdata" action="editprofile"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="firstname" id="firstname" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['firstname']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="lastname" id="lastname" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['lastname']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="designation" id="designation" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['designation']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="companyname" id="companyname" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['companyname']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="dateofbirth" id="dateofbirth" class="form-control"
                                                           ...
                                                           value="<?php echo $fetched_user_data['dateofbirth']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="phone" id="phone" class="form-control" type="text"
                                                           value="<?php echo $fetched_user_data['phone']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="address" id="address" class="form-control" type="text"
                                                           value="<?php echo $fetched_user_data['address']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Facebook Link</label>
                                                <div class="col-lg-8">
                                                    <input name="facebooklink" id="facebooklink" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['facebooklink']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Instagram Link</label>
                                                <div class="col-lg-8">
                                                    <input name="instagramlink" id="instagramlink" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['instagramlink']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Twitter Link</label>
                                                <div class="col-lg-8">
                                                    <input name="twitterlink" id="twitterlink" class="form-control"
                                                           type="text"
                                                           value="<?php echo $fetched_user_data['twitterlink']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">About Yourself:</label>
                                                <div class="col-md-8">
                                                    <textarea name="aboutuser" id="aboutuser" class="form-control"
                                                              rows="5" placeholder="Write something about yourself..."
                                                              value="<?php echo $fetched_user_data['aboutuser']; ?>"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Change Profile Picture:</label>
                                                <div class="col-md-8">
                                                    <input name="imagename" id="imagename" type="file"
                                                           class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
